	...
	<div id="content" class="grid grid-container grid-wide">
		<style>
			...
			@media print {
				...
				body {border-top: 0px solid transparent;}
				h1, h1 small {
					font-size: 9pt;
					font-weight: bold;
				}
		...
		<div id="nextevents1" class="large-6 cutout">
			<div class="grid">
				<div class="large-12 dsa-nextevents-title">
				...
				<?php // Retrieve the next 5 upcoming events
					if(in_array('the-events-calendar/the-events-calendar.php', apply_filters('active_plugins', get_option('active_plugins')))){ 
						...
						foreach ( $events as $event ) {
						    ...
						    echo "<div class=\"card large-10\"><h4><b>";
						...
						echo '<div class="large-12">This template uses The Events Calendar plugin. Please install.</div>';
					}
				?>
			</div>
		</div> 
		<div id="nextevents2" class="large-6">
			<div class="grid">
				<div class="large-12 dsa-nextevents-title">
					<h1><span class="icon-calendar"></span> <?php bloginfo('name'); ?> <small>Upcoming Events</small></h1>
				</div>
