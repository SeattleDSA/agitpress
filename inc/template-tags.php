...
if ( ! function_exists( 'agitpress_wp_posted_on' ) ) :
	...
	function agitpress_wp_posted_on() {
		...
		$posted_on = sprintf(
			...
			esc_html_x( '%s', 'post date', 'agitpress' ),
...
if ( ! function_exists( 'agitpress_wp_entry_tags' ) ) :
	 ...
	 */
	function agitpress_wp_entry_tags() {
...
if ( ! function_exists( 'agitpress_wp_post_thumbnail_url' ) ) :
	/**
	 * Displays an optional post thumbnail.
	 *
	 * Wraps the post thumbnail in an anchor element on index views, or a div
	 * element when on single views.
	 */
	function agitpress_wp_post_thumbnail_url() {
		if ( post_password_required() || is_attachment() || ! has_post_thumbnail() ) {
			return;
		}
